        ...
        public void startElement(String uri, String localName, String name,
            ...
            if ("inlineStr".equals(name) || "v".equals(name)) {
                ...
                if ("b".equals(cellType)) {
                    ...
                    if ("M/D/YYYY".equals(formatString) || "m/d/yy".equals(formatString)) {
            ...
            if ("v".equals(name)) {
                ...
                switch (nextDataType) {
                    ...
                    case INLINESTR:
                        ...
                        thisStr = '"' + rtsi.toString().replaceAll("\"", "”").replaceAll("\n", " ") + '"';
                        break;
                    ...
                    case SSTINDEX:
                        ...
                        try {
                            ...
                            thisStr = '"' + rtss.toString().replaceAll("\"", "”").replaceAll("\r", "").replaceAll("\n", " ").trim() + '"';
